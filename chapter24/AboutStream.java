...
public class AboutStream {
	public static void main(String[] args) {
		...
		//boolean test(T t)
		IntStream stm2=stm1.filter(n->n%2==1); //filter : 리턴문이 true인 경우만 스트림으로 리턴해 줌
		int sum=stm2.sum();
